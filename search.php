...
<div class="row mb-2 mt-2 pb-4 pt-4 pb-2">
    <div class="col-md-12">
        <h5 class="pt-3 pb-2 heading-sm-b text-danger">
            <i class="fa fa-exclamation-triangle"></i> <?php _e ( 'Nothing found matching your serach criteria!', 'CT22' );?> 
        </h5>
        <div class="pt-5 pb-5">
            <p><?php  _e( 'You can try searching again below:', 'CT22' );?></p>
...
<?php endif;?> 
        <div class="row pt-2 pb-2"> 
            <div class="col-md-12"><?php CTight_pagination();?></div>
        </div>
    </div>
</div>
</div>

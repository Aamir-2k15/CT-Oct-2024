    ...
    <?php if (have_posts()) :?>
        ...
        <div class="content">
                    ...
                    <div class="row border-bottom mb-2 mt-2 pb-4 pt-4 pb-2 pos-<?php echo $i; ?>?>">
                        <div class="col-md-2"><?php if (has_post_thumbnail()) { ?>
                                ...
                                <a href="<?= the_permalink(); ?>" class="entry__thumb-link pt-2 pb-2">
                                    <img src="<?php echo $image[0]; ?>" class="img-fluid" width="100%" height="auto"/></a><?php } ?>
                        </div>
                        <div class="col-md-10">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-md-12"><?php if(!empty(CT_SETTINGS['CT_numbered_pagination']) && CT_SETTINGS['CT_numbered_pagination'] == true): _pagination(); endif;?></div>
            </div>
            <?php else: ?>
